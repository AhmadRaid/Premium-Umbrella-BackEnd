...
import { InvoiceEmployeeService } from './invoice.service';
...
export class InvoiceEmployeeController {
  constructor(private readonly invoiceService: InvoiceEmployeeService) {}
