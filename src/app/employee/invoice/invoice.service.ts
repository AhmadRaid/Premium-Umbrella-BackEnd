...
import { ClientEmployeeService } from '../client/client.service';
import { OrdersEmployeeService } from '../orders/orders.service';
import { Invoice } from 'src/schemas/invoice.schema';
import { CreateInvoiceDto } from './dto/create-invoice.dto';
import { User } from 'src/schemas/user.schema';

@Injectable()
export class InvoiceEmployeeService {
  constructor(
    @InjectModel(Invoice.name) private invoiceModel: Model<Invoice>,
    private readonly clientService: ClientEmployeeService,
