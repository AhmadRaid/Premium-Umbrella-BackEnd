...
import { CarTypeEmployeeService } from './type-cars.service';
...
export class CarTypeEmployeeController {
  constructor(private readonly carTypeService: CarTypeEmployeeService) {}
