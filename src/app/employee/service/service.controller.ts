...
import { ServicesEmployeeService } from './service.service';
...
export class ServicesEmployeeController {
  constructor(private readonly servicesService: ServicesEmployeeService) {}
